...
public static class ForgeClient
{
    ...
    /// <summary>Rewrite legacy forge.sp-tarkov.com hosts to the configured BaseUrl host.</summary>
    public static string RewriteLegacyHost(string? url)
    {
        if (string.IsNullOrWhiteSpace(url)) return url ?? "";
        try
        {
            var u = url.Replace("https://forge.sp-tarkov.com", BaseUrl, StringComparison.OrdinalIgnoreCase)
                       .Replace("http://forge.sp-tarkov.com", BaseUrl, StringComparison.OrdinalIgnoreCase)
                       .Replace("https://www.forge.sp-tarkov.com", BaseUrl, StringComparison.OrdinalIgnoreCase);
            return u;
        }
        catch { return url; }
    }
