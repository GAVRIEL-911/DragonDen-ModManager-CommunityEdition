...
public partial class SettingsPage : UserControl
{
    ...
    private void ToggleTokenVisibility(bool show)
    {
        ...
        ShowTokenToggle.Content = show ? Loc.T("Common.Hide") : Loc.T("Common.Show");
    }
    ...
    private void OnResetDataFolder(object? s, RoutedEventArgs e)
    {
        ...
        App.SaveConfig();
        Notifications.Current.ShowSuccess(Loc.T("Notify.DataFolderReset"), Loc.T("Notify.DataFolderResetBody"));
    ...
    private async void OnBrowseDataFolder(object? s, RoutedEventArgs e)
    {
        ...
        {
            AllowMultiple = false,
            Title = Loc.T("Dialog.SelectDataFolder")
        });
        ...
        {
            Notifications.Current.ShowError(Loc.T("Notify.InvalidFolder"), Loc.T("Notify.FolderNotExist"));
        ...
        App.SaveConfig();
        Notifications.Current.ShowSuccess(Loc.T("Notify.DataFolderChanged"), Loc.T("Notify.DataFolderChangedBody"));
    ...
    private async void OnBrowseSptSptFolder(object? s, RoutedEventArgs e)
    {
        ...
        {
            AllowMultiple = false,
            Title = Loc.T("Dialog.SelectSptFolder")
        });
        ...
        if (TryFindSptExe(root, out var exePath))
            try
            {
                ...
                SptStatusText.Text = string.IsNullOrWhiteSpace(friendly)
                    ? Loc.T("Settings.SptDetectedUnknown")
                    : Loc.T("Settings.SptDetected", friendly);
            }
            catch
            {
                SptStatusText.Text = Loc.T("Settings.SptDetectedUnknown");
            }
        else
            SptStatusText.Text = Loc.T("Settings.SptNotFound");
    }
